...
import { ApproveLeaveRequestDocument, RejectLeaveRequestDocument } from '../../api/graphql/graphql';
...
describe.each([
  ['approve', ApproveLeaveRequestDocument],
  ['reject', RejectLeaveRequestDocument],
] as const)('%s leave request GraphQL document', (_decision, document) => {
