...
import CelebrationPreferencesCard from './CelebrationPreferencesCard';
...
const TOPICS: { id: string; label: string; hint: string }[] = [
  ...
  { id: 'celebration', label: 'Celebrations', hint: 'Birthday and work-anniversary alerts' },
