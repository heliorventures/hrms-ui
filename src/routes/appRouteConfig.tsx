...
export const TENANT_APP_ROUTES: AppChildRoute[] = [
  ...
  { path: 'leave/holidays', element: <LeaveHolidaysPage /> },
  ...
  { path: 'organization/employees', element: <OrganizationEmployeesPage /> },
  { path: 'organization/employees/:employeeId', element: <EmployeeDetailPage /> },
  { path: 'organization/org-chart', element: <OrgChartPage /> },
  { path: 'organization/documents', element: <OrganizationDocumentsPage /> },
