...
export const NAV_CATALOG: NavCatalogEntry[] = [
  ...
  },
  {
    ...
    label: 'HR — leave types & holidays',
    group: 'HR',
    keywords: ['leave policy', 'holiday calendar', 'leave balance', 'provision', 'pto', 'sick leave'],
  },
  ...
  },
  {
    ...
    group: 'Admin',
    keywords: ['leave types', 'policies', 'balances', 'holidays', 'calendar', 'pto config', 'hr leave'],
    adminOnly: true,
  },
